...
def main():
	...
	for i, row in enumerate(scan1):
		...
		_point_array = np.array([[_z1],[_x1],[_y1]]) # yaw, pitch, roll
		_rotation = R.from_euler('zyx', [args.yaw, args.pitch, args.roll], degrees=True)
		...
		print('output: ',np.reshape(_point_array, len(_point_array)), _rotated_point_array)
